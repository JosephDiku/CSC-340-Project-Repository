...
| Joseph Diku   | 12/11/2025 | Updated document based on new functionalities |   1.0     |
...
- Customer/Member (Reader): A user who registers to access, subscribe to, and review books.
- Provider (Author): A user who registers to upload, manage books, and respond to customer feedback.

### 1.4 References
- IEEE Recommended Practice for Software Specifications

### 1.5 Document Overview
- Section 2: provides an overview of the product, including major functions, constraints, user characteristics, and dependencies.
- Section 3: specifies functional and non-functional requirements in detail.

## 2. Product Overview

### 2.1 Product Functions
- Customer/Member (Reader)
    * Subscribe to access libraries
    * Browse libraries
    * Leave reviews and ratings
    * Add books to their Favorites List
    * View dashboard of books read
- Provider (Author)
    * Subscribe to gain publishing access
    * Upload and manage digital books
    * View customer-related statistics
...
- Design Constraints: The platform will require role-based access to support both customer and provider needs.
  
### 2.3 User Characteristics
- Customers (Readers)
    * Customers are expected to have moderate technical understanding, with the ability to browse and understand basic searching techniques.
    * Customers are expected to have elementary navigation skills and a firm understanding of subscription systems
- Providers (Authors)
    * Providers are expected to have moderate technical skills, with an understanding of uploading content and monitoring an audience.
...
*  FR1: The system will allow authors to publish books to the library with the title and description.
*  FR2: The system will allow members to browse through the library to look for books.
*  FR3: Members and Authors can edit their profiles at any time.
*  FR4: Users will be able to browse their dashboard to look at their books and reviews they made.
*  FR5: The system will allow users to leave a rating and review on books in the library.
*  FR6: The system will allow the authors to respond to reviews left by members on their books
...
Devices with the ability to use a web browser will have access to our page.
...
#### 3.2.1 Performance
* NFR0: The BookNexus System will consume less than 125 MB of memory
* NFR1: A new member will be able to set up an account and profile in less than 5 minutes
* NFR2: A new author will understand how to publish books and manage their account within 10 minutes
* NFR2: An intermediate user will completely understand how both author and member accounts work

#### 3.2.2 Security
* NFR3: Members and Authors must make an account to use the system
...
#### 3.2.6 Cost
* NFR6: We acknowledged that there will be no money spent on this project

#### 3.2.7 Deadline
* NFR7: The final product has to be delivered by December 2025
